    ...
    return (
        <div id="households-page" className="page p-6">
            <div className="mb-6 flex justify-between items-center">
                ...
                <button onClick={() => setOpen(true)} id="add-household-btn" className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-md flex items-center">
            ...
            <button onClick={() => setOpen(true)} id="add-household-floating-btn" className="floating-button md:hidden fixed bottom-6 right-6 w-14 h-14 bg-indigo-600 text-white rounded-full shadow-lg flex items-center justify-center">
